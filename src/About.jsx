      ...
      <div className="bg-[#011627] min-h-screen w-screen pt-24 grid grid-cols-2">
        <div className="text-white font-rubik p-4">
          ...
          <p className="text-lg">
            ...
            tailored to your unique specifications. Whether you're an
            individuals maker, a professional engineer, or a business seeking
            custom components, Matzu Prints is your trusted partner in bringing
